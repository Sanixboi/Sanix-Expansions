...
public class InfersicoSeedCrop extends CropBlock implements ModdedFertilizable {

    public InfersicoSeedCrop(Settings settings) {
        super(settings);
    }

    @Environment(EnvType.CLIENT)
    protected ItemConvertible getSeedsItem() {
        return ModItems.INFERSICO_SEEDS;
    }
