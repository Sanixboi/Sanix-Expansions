...
public class SupericioSeedCrop extends CropBlock implements ModdedFertilizable {

    public SupericioSeedCrop(Settings settings) {
        super(settings);
    }

    @Environment(EnvType.CLIENT)
    protected ItemConvertible getSeedsItem() {
        return ModItems.SUPERICIO_SEEDS;
    }
