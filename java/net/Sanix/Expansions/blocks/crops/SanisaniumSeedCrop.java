...
public class SanisaniumSeedCrop extends CropBlock implements ModdedFertilizable {

    public SanisaniumSeedCrop(Settings settings) {
        super(settings);
    }

    @Environment(EnvType.CLIENT)
    protected ItemConvertible getSeedsItem() {
        return ModItems.SANISANIUM_SEEDS;
    }
