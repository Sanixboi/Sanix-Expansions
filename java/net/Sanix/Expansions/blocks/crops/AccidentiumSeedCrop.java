...
public class AccidentiumSeedCrop extends CropBlock implements ModdedFertilizable {

    public AccidentiumSeedCrop(Settings settings) {
        super(settings);
    }

    @Environment(EnvType.CLIENT)
    protected ItemConvertible getSeedsItem() {
        return ModItems.ACCIDENTIUM_SEEDS;
    }
