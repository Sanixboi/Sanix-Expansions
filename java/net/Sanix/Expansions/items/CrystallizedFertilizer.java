...
public class CrystallizedFertilizer extends Item {
    public CrystallizedFertilizer(Settings settings) {
        super(settings);
    }
    ...
    public static boolean useOnMagicFertilizable(ItemStack stack, World world, BlockPos pos) {
        ...
        if (blockState.getBlock() instanceof ModdedFertilizable) {
            ...
            if (fertilizable.isCrystallizedFertilizable(world, pos, blockState, world.isClient)) {
