...
public class MysticalFertilizer extends Item {
    public MysticalFertilizer(Settings settings) {
        super(settings);
    }
    ...
    public static boolean useOnMagicFertilizable(ItemStack stack, World world, BlockPos pos) {
        ...
        if (blockState.getBlock() instanceof ModdedFertilizable fertilizable) {
            if (fertilizable.isMysticalFertilizable(world, pos, blockState, world.isClient)) {
